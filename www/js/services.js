...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://klasikshop-3e198.firebaseio.com/"),
    refCart = new Firebase("https://klasikshop-3e198.firebaseio.com/cart"),
    refUser = new Firebase("https://klasikshop-3e198.firebaseio.com/users"),
    refCategory = new Firebase("https://klasikshop-3e198.firebaseio.com/category"),
    refOrder = new Firebase("https://klasikshop-3e198.firebaseio.com/orders"),
    refFeatured = new Firebase("https://klasikshop-3e198.firebaseio.com/featured"),
    refMenu = new Firebase("https://klasikshop-3e198.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
